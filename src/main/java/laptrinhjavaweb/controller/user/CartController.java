...
public class CartController extends BaseController {
	...
	public ModelAndView Checkout(Model model, HttpServletRequest request, HttpSession session,
		...
		if (user != null) {
			bills.setFull_name(user.getFull_name());
			bills.setLogin_name(user.getLogin_name());
	...
	public String CheckoutBill(Model model, HttpServletRequest request, HttpSession session, @ModelAttribute("bills") Bills bills) {
