        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <a href="<c:url value="/admin/load-product"/>" class="page-title">Go back</a>
            </div>
          </div>
        </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                     <label for="fname" class="col-sm-3 control-label col-form-label">Thuộc danh mục</label>
                      <div class="col-sm-9">
                       <form:select path="id_category" class="select2 form-select shadow-none" style="width: 100%; height: 36px">
                    ...
                    <div class="form-group row">
                     <label for="fname" class="col-sm-3 control-label col-form-label">Ảnh</label>
                      <div class="col-md-9">
                       <div class="custom-file" >
                        <form:input value="" path="image" type="file" class="custom-file-input" id="validatedCustomFile"/>
                       </div>
                  	  </div>
                  	 </div>
